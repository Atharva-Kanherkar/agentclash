...
CREATE TABLE workspace_regression_cases (
    ...
    promotion_mode                   text        NOT NULL CHECK (promotion_mode IN ('full_executable', 'output_only', 'manual')),
    source_run_id                    uuid,
    source_run_agent_id              uuid,
    source_replay_id                 uuid,
    source_challenge_pack_version_id uuid        NOT NULL REFERENCES challenge_pack_versions (id),
    source_challenge_input_set_id    uuid        REFERENCES challenge_input_sets (id),
    source_challenge_identity_id     uuid        NOT NULL,
...
CREATE TABLE workspace_regression_promotions (
    ...
    source_run_agent_id         uuid        NOT NULL,
