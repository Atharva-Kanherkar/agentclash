...
import { TrackedButton } from "@/components/analytics/tracked-cta";
...
export function SignInButton({
  ...
  return (
    <form action={action}>
      ...
      <TrackedButton
        type="submit"
        ctaId={`auth-login.form.${mode === "signup" ? "signup" : "sign_in"}`}
        intent={mode === "signup" ? "signup" : "sign_in"}
        placement="form"
        destinationKind="workos"
