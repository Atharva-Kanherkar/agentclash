...
* **cli:** process exit codes for API/transport failures changed from 1 to the documented failure-class band (64/66/75/77). Branch on `error.code` or the documented codes in `agentclash schema`, not on the literal value 1.
...
* **cli:** cap Retry-After at 24h (duration overflow) + serialize flag-mutating tests ([432aaf1](https://github.com/agentclash/agentclash/commit/432aaf103a9fc130b05c07bd701e4289a4f7fff8))
