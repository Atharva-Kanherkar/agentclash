...
func TestEvalSetStatusTransitions(t *testing.T) {
	cases := []struct {
		...
		{domain.EvalSetStatusRunning, domain.EvalSetStatusBudgetExceeded, true},
		{domain.EvalSetStatusAggregating, domain.EvalSetStatusBudgetExceeded, true},
		{domain.EvalSetStatusBudgetExceeded, domain.EvalSetStatusRunning, false},
