...
## E2E Tests
- N/A for local automation — full package-manager publishing requires repository secrets and a Homebrew tap.
...
- Install matrix after release:
  ...
  - Windows amd64 and arm64: `install.ps1` or direct zip.
