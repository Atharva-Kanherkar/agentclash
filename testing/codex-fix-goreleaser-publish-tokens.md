...
## Functional Behavior
- GoReleaser repository tokens for Homebrew must use direct `.Env` template references.
...
- Homebrew recovery for `v0.2.0` must use the published release assets and checksums.
